...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x16, 0x00), AMD_UMCDF_ZEN_PRE_ZEN,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_PRE_ZEN (%d)",
	    0x16, 0x00,
	    (int)amd_umcdf_map_zen(0x16, 0x00), (int)AMD_UMCDF_ZEN_PRE_ZEN);
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x00, 0x00), AMD_UMCDF_ZEN_PRE_ZEN,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_PRE_ZEN (%d)",
	    0x00, 0x00,
	    (int)amd_umcdf_map_zen(0x00, 0x00), (int)AMD_UMCDF_ZEN_PRE_ZEN);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1b, 0x00), AMD_UMCDF_ZEN_FUTURE,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_FUTURE (%d)",
	    0x1b, 0x00,
	    (int)amd_umcdf_map_zen(0x1b, 0x00), (int)AMD_UMCDF_ZEN_FUTURE);
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0xff, 0x00), AMD_UMCDF_ZEN_FUTURE,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_FUTURE (%d)",
	    0xff, 0x00,
	    (int)amd_umcdf_map_zen(0xff, 0x00), (int)AMD_UMCDF_ZEN_FUTURE);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x01), AMD_UMCDF_ZEN_1,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_1 (%d)",
	    0x17, 0x01,
	    (int)amd_umcdf_map_zen(0x17, 0x01), (int)AMD_UMCDF_ZEN_1);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x07), AMD_UMCDF_ZEN_1,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_1 (%d)",
	    0x17, 0x07,
	    (int)amd_umcdf_map_zen(0x17, 0x07), (int)AMD_UMCDF_ZEN_1);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x11), AMD_UMCDF_ZEN_1,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_1 (%d)",
	    0x17, 0x11,
	    (int)amd_umcdf_map_zen(0x17, 0x11), (int)AMD_UMCDF_ZEN_1);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x08), AMD_UMCDF_ZEN_PLUS,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_PLUS (%d)",
	    0x17, 0x08,
	    (int)amd_umcdf_map_zen(0x17, 0x08), (int)AMD_UMCDF_ZEN_PLUS);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x18), AMD_UMCDF_ZEN_PLUS,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_PLUS (%d)",
	    0x17, 0x18,
	    (int)amd_umcdf_map_zen(0x17, 0x18), (int)AMD_UMCDF_ZEN_PLUS);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x31), AMD_UMCDF_ZEN_2,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_2 (%d)",
	    0x17, 0x31,
	    (int)amd_umcdf_map_zen(0x17, 0x31), (int)AMD_UMCDF_ZEN_2);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x71), AMD_UMCDF_ZEN_2,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_2 (%d)",
	    0x17, 0x71,
	    (int)amd_umcdf_map_zen(0x17, 0x71), (int)AMD_UMCDF_ZEN_2);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x17, 0x00), AMD_UMCDF_ZEN_UNKNOWN,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_UNKNOWN (%d)",
	    0x17, 0x00,
	    (int)amd_umcdf_map_zen(0x17, 0x00), (int)AMD_UMCDF_ZEN_UNKNOWN);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0x00), AMD_UMCDF_ZEN_3,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_3 (%d)",
	    0x19, 0x00,
	    (int)amd_umcdf_map_zen(0x19, 0x00), (int)AMD_UMCDF_ZEN_3);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0x21), AMD_UMCDF_ZEN_3,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_3 (%d)",
	    0x19, 0x21,
	    (int)amd_umcdf_map_zen(0x19, 0x21), (int)AMD_UMCDF_ZEN_3);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0x40), AMD_UMCDF_ZEN_3_PLUS,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_3_PLUS (%d)",
	    0x19, 0x40,
	    (int)amd_umcdf_map_zen(0x19, 0x40), (int)AMD_UMCDF_ZEN_3_PLUS);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0x10), AMD_UMCDF_ZEN_4,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_4 (%d)",
	    0x19, 0x10,
	    (int)amd_umcdf_map_zen(0x19, 0x10), (int)AMD_UMCDF_ZEN_4);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0x61), AMD_UMCDF_ZEN_4,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_4 (%d)",
	    0x19, 0x61,
	    (int)amd_umcdf_map_zen(0x19, 0x61), (int)AMD_UMCDF_ZEN_4);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x19, 0xa0), AMD_UMCDF_ZEN_4,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_4 (%d)",
	    0x19, 0xa0,
	    (int)amd_umcdf_map_zen(0x19, 0xa0), (int)AMD_UMCDF_ZEN_4);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1a, 0x00), AMD_UMCDF_ZEN_5,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_5 (%d)",
	    0x1a, 0x00,
	    (int)amd_umcdf_map_zen(0x1a, 0x00), (int)AMD_UMCDF_ZEN_5);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1a, 0x44), AMD_UMCDF_ZEN_5,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_5 (%d)",
	    0x1a, 0x44,
	    (int)amd_umcdf_map_zen(0x1a, 0x44), (int)AMD_UMCDF_ZEN_5);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1a, 0x50), AMD_UMCDF_ZEN_6,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_6 (%d)",
	    0x1a, 0x50,
	    (int)amd_umcdf_map_zen(0x1a, 0x50), (int)AMD_UMCDF_ZEN_6);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1a, 0x80), AMD_UMCDF_ZEN_6,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_6 (%d)",
	    0x1a, 0x80,
	    (int)amd_umcdf_map_zen(0x1a, 0x80), (int)AMD_UMCDF_ZEN_6);
}
...
{
	ATF_CHECK_EQ_MSG(amd_umcdf_map_zen(0x1a, 0xc0), AMD_UMCDF_ZEN_6,
	    "map_zen(family=%#x, model=%#x) = %d, expected AMD_UMCDF_ZEN_6 (%d)",
	    0x1a, 0xc0,
	    (int)amd_umcdf_map_zen(0x1a, 0xc0), (int)AMD_UMCDF_ZEN_6);
}
